...
#     return output
#
# def save_training_nonlinear_output(output):
#     """
#     Save the training of the trainable QML model output to file.
#     """
#     if not os.path.exists("./data"):
#         os.makedirs("./data")
#     dump(output, open("./data/train_nonlinear.p", "wb"))
#     return
#
# def load_training_nonlinear_output():
#     """
#     Load the training of the trainable QML model output from file.
#     """
#     output = load(open("./data/train_nonlinear.p", "rb"))
#     return output
#
#
...
#     return output
#
# def save_nonlinear_robustness_output(output):
#     """
#     Save the robustness output for the trainable encoding QML model to file.
#     """
#     if not os.path.exists("./data"):
#         os.makedirs("./data")
#     dump(output, open("./data/robustness_nonlinear.p", "wb"))
#     return
#
# def load_nonlinear_robustness_output():
#     """
#     Load the robustness output for the trainable encoding QML model from file.
#     """
#     output = load(open("./data/robustness_nonlinear.p", "rb"))
#     return output
#
#
...
#     return output
#
# def save_nonlinear_generalization_output(output):
#     """
#     Save the generalization output for the trainable encoding QML model to file.
#     """
#     if not os.path.exists("./data"):
#         os.makedirs("./data")
#     dump(output, open("./data/generalization_nonlinear.p", "wb"))
#     return
#
# def load_nonlinear_generalization_output():
#     """
#     Load the generalization output for the trainable encoding QML model from file.
#     """
#     output = load(open("./data/generalization_nonlinear.p", "rb"))
#     return output
